    ...
    public void createAvailableTimesTable() throws URISyntaxException, IOException {
        ...
        if (service != null && employee != null) {
            ...
            try (CloseableHttpClient httpClient = HttpClientBuilder.create().build()) {
                ...
                HttpGet apiget = new HttpGet("http://localhost:62975/api/appointments/GetTimes");
                ...
                loadDialog("Failed", "Failed to connect to the database please close the application or click the refresh button");
            }
        } else {
            loadDialog("Failed", "Please make sure a record from the servie and employee table are selected");
        }
